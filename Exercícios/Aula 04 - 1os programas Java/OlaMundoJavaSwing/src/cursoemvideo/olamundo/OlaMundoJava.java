...
public class OlaMundoJava extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setBackground(new java.awt.Color(16, 0, 43));
        setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        setForeground(new java.awt.Color(16, 0, 43));
        setResizable(false);

        lblMensagem.setFont(new java.awt.Font("Lucida Sans", 1, 18)); // NOI18N
        lblMensagem.setForeground(new java.awt.Color(204, 51, 255));
        lblMensagem.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lblMensagem.setText("Aqui vai aparecer a mensagem");

        btnClick.setFont(new java.awt.Font("Lucida Sans", 0, 14)); // NOI18N
        btnClick.setText("Clique em mim");
        btnClick.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
    ...
    private void btnClickActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnClickActionPerformed
        lblMensagem.setText("Olá, mundo!!!"); // quando o botão for presssionado, o texto da label lblMensagem vai mudar
